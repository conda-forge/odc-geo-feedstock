...
Once the `conda-forge` channel has been enabled, `odc-geo` can be installed with:

```
conda install odc-geo
```

It is possible to list all of the versions of `odc-geo` available on your platform with:
